...
fully before raising their opinions. When there is a disagreement, a knowledgable
third person should be pulled in to resolve the deadlock. This person takes on
the role of being the resolver of the deadlock, thus resolver should listen and
evaluate both sides of the argument well and then has to be decisive and come up
with a decision if both sides still disagrees. Building software is teamwork so
we should make sure we respond, discuss and resolve issues in timely manner to
remove lead times when disagreements arise in code reviews.
